...
use App\Http\Controllers\Pages\HelpCenterController;
use App\Http\Controllers\Pages\PrivacyController;
use App\Http\Controllers\Pages\SecurityController;
...
Route::prefix('/u/{username}')->group(function () {
    ...
    Route::get('/gallery/show', [MediaController::class, 'show'])->name('gallery.show');
    Route::get('/gallery/edit', [MediaController::class, 'edit'])->name('gallery.edit');
    Route::get('/media/uploadForm',[MediaController::class,'uploadImageForm'])->name('media.uploadImageForm');
    Route::post('/media/uploadFormSubmit', [MediaController::class, 'uploadImage'])->name('media.uploadImage');
    ...
    Route::get('/all-testing-list',[TestingController::class,'index'])->name('testing.index');

    Route::get('/testing', [TestingController::class,'show'])->name('testing.show');

    Route::post('/testing/store',[TestingController::class,'store'])->name('testing.store');

    Route::get('/testing/edit',[TestingController::class,'edit'])->name('testing.edit');

    Route::put('/testing/update',[TestingController::class,'update'])->name('testing.update');
});
