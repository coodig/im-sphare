    ...
    <div class="main-wrapper">
        ...
        <div class="navbar">
            ...
            <div class="navbar-right">
                ...
                @auth
                <span class="welcome user-name">Welcome,&nbsp;{{ ucwords(Auth::user()->profile->name ??
        ...
        <div class="main-content">
            <section id="imsphare-hero">
                ...
                <div id="imsphare-hero-content">
                    ...
                    <x-action-button url="{{ route('dashboard.show', [
                ...
                <div class="imsphare-testimonial">
                    <div class="imsphare-testimonials-content">
                        ...
                        <div class="testimonial-text">
                            <h1 class="text-4xl font-bold underline text-red-300">
                                thsi is adarsh-vishwakarama-9a9a15210
                            </h1>
...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .scroll-trigger { opacity: 0; } /* Hidden initially */
...
<body class="antialiased selection:bg-primary selection:text-white">
            ...
            <section id="imsphare-features"
                ...
                <div class="flex flex-col-reverse md:flex-row items-center justify-between gap-12 max-w-7xl mx-auto">
                    <div class="grid grid-cols-1 gap-6 w-full md:w-1/2 text-left pl-0 md:pl-12">
                        <div
                            class="flex items-center gap-4 text-xl font-medium text-text-main group scroll-trigger delay-100">
                            <iconify-icon icon="noto:artist-palette"
                                class="text-4xl group-hover:-translate-y-1 transition-transform"></iconify-icon>
                            Easy Portfolio Builder
                        </div>
                        <div
                            class="flex items-center gap-4 text-xl font-medium text-text-main group scroll-trigger delay-200">
                            <iconify-icon icon="noto:high-voltage"
                                class="text-4xl group-hover:-translate-y-1 transition-transform"></iconify-icon>
                            Fast & Responsive
                        </div>
                        <div
                            class="flex items-center gap-4 text-xl font-medium text-text-main group scroll-trigger delay-300">
                            <iconify-icon icon="noto:bar-chart"
                                class="text-4xl group-hover:-translate-y-1 transition-transform"></iconify-icon>
                            Analytics & Insights
                        </div>
                        <div
                            class="flex items-center gap-4 text-xl font-medium text-text-main group scroll-trigger delay-400">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            }, { threshold: 0.15 }); // Trigger earlier for smoother feel
