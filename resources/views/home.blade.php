...
<div class="homepage-container">
    ...
    <section class="hero-section">
        ...
        <div class="hero-image">
            <img src="{{ asset('asset/img/about.jpg') }}" alt="Adarsh Photo">
        </div>
    </section>
    ...
    <section class="about-section" id="about">
        <h2>👋 About Me</h2>
        <p>I’m a passionate developer building AI-integrated apps, gesture-controlled tech, and Laravel-powered systems. I love solving real-world problems with code.</p>
    </section>
