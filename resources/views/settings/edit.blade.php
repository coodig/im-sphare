    ...
    <div class="settings_container">
        ...
        <div class="settings-section">
            <div>
                ...
                <a href="{{route('settings.show', ['username' => Auth::user()->username])}}">Back</a>
                {{-- <a href="{{route('settings.update')}}">Update</a> --}}
            </div>
            ...
            <form action="" method="POST" class="settings-form">
                ...
                <div class="form_element">
                    ...
                    --}}
                    {{-- <p id="name" name="name" class="name" value="{{Auth::user()->profile->name ?? ''}}"></p> --}}
        ...
        {{-- <div class="settings-section">
            ...
            <div class="api-key-box">
                <code
                    id="apiKeyBox">pk_live_2xasd823jksdu190apk_live_2xasd823jksdu190apk_live_2xasd823jksdu190apk_live_2xasd823jksdu190aspk_live_2xasd823jksdu190apk_live_2xasd823jksdpk_live_2xasd823jksd...u190a...u190a</code>
