...
class AboutController extends Controller
{
    ...
    public function edit($username){
        ...
        $user_about = UserAbout::where('user_id',Auth::id())->firstOrFail();
        return view('about.edit',compact('user_about'));
    }


    public function update(Request $request,$username){
        // if(Auth::user()->profile->username !== $username){
        //     abort(403,'Unauthorized action');
        // }
        ...
        // if ($user_about->image && Storage::exists('public/' . $user_about->image)) {
        //     Storage::disk('public')->delete($user_about->image);
            // Storage::delete('public/' . $user_about->image);
        // }
        ...
        $user_about ->save();
// dd($user_about);
        return redirect()->route('about_me.show',$username)->with('message','About Me page updated successfully');
